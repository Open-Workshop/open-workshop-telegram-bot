...
Основной код лежит в `src/open_workshop_telegram_bot/`. Корневой `main.py` оставлен как совместимый thin wrapper.
...
Для запуска можно использовать `python3 main.py` или `PYTHONPATH=src python3 -m open_workshop_telegram_bot`.
